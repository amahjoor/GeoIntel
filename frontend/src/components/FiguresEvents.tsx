            ...
            <div key={index} className="border rounded-lg p-4 bg-gray-50">
              <div className="flex justify-between items-start mb-2">
                <div>
                  ...
                  <p className="text-black">{figure.position}</p>
                </div>
                {figure.party && (
              ...
              <p className="text-black mb-3">{figure.significance}</p>
              ...
              <div className="space-y-2">
                {figure.key_events.map((event, eventIndex) => (
                  <div key={eventIndex} className="border-l-4 border-blue-500 pl-3">
                    ...
                    <div className="text-sm text-black">{event.impact}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="space-y-4">
          {data.recent_events.map((event, index) => (
            <div key={index} className="border rounded-lg p-4">
              ...
              <p className="text-black mb-2">{event.impact}</p>
